  ...
  return (
    <div>
      ...
      <div className="container text-center">
        <img
          src="https://i.ibb.co/CbKj5s5/Color-logo-with-background.png"
          alt=""
          style={{ height: "450px" }}
        />
      </div>
      <div className="about-logo">
        <img
          src="https://evernote.com/c/assets/homepage/homepage-quote.svg?57f9da0de97e581d"
          alt=""
        />
      </div>
      <blockquote
        className="logo-carousel-quote text-center"
        style={{ padding: "0 20px" }}
      >
        "A few years ago, after my computer broke down and I lost all of the
        notes I had saved to my desktop, I finally decided to embrace the cloud
        and download Evernote. Since then, I haven’t looked back."
      </blockquote>
      <blockquote className="logo-carousel-company text-center">
      ...
      <div
        className="container dev-profile"
        style={{ marginTop: "50px", marginBottom: "90px" }}
      >
        <figure className="snip0045 red">
          <figcaption>
            <h2>
              Anand <span>Patel</span>
            </h2>
            <p>
              Computer Science Student at Charotar University Of Science &
              Technology (CHARUSAT)
            </p>
            <div className="icons">
              <Link to="/">
