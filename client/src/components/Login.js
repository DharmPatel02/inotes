    ...
    <div style={{ overflowY: "hidden" }}>
      <section className="login-height">
        ...
        <div className="container-fluid h-custom">
          <div className="row d-flex justify-content-center align-items-center h-100">
            ...
            <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1 login-content">
              <form>
                <div className="signin-social align-items-center justify-content-center justify-content-lg-start mt-4">
                  {/* <FacebookLogin
                  ...
                  /> */}
                  <div id="g_id_signin" className="g_id_signin social-google">
                    {" "}
                  </div>
                </div>

                <div className="divider d-flex align-items-center my-4">
                  <p className="text-center fw-bold mx-3 mb-0 text-uppercase">
                    Or
                  </p>
                </div>
                ...
                <div
                  className="form-outline mb-3 d-flex pass_show"
                  style={{ justifyContent: "end" }}
                >
                  <input
                    type={logpassshow ? "password" : "text"}
                    id="password"
                    className="form-control form-control-lg"
                  ...
                  <FontAwesomeIcon
                    className="my-2"
                    icon={logpassicon ? faEyeSlash : faEye}
                    style={{
                      position: "absolute",
                      marginRight: "15px",
                      paddingTop: "7px",
                ...
                <div className="end-login text-center text-lg-start mt-4 pt-2">
                  <button
                    type="button"
                    className="btn btn-primary text-uppercase btn-md shadow  rounded"
                    style={{
                      paddingLeft: "2.5rem",
                      paddingRight: "2.5rem",
                      fontWeight: "bold",
        ...
        >
          ...
          {/* <div className="text-white mb-3 mb-md-0">FSD PROJECT</div> */}
